...
public class PinYin {
	...
	public static int getCnAscii(char cn) {
		...
		try {
			...
			e.printStackTrace(); // (String.valueOf(cn)).getBytes();
			return 0;
		}
	...
	public static String getSpellByAscii(int ascii) {
		if (ascii > 47 && ascii < 58) { // 单字符
			return String.valueOf((char) ascii);
		}
		if (ascii > 64 && ascii < 91) { // 单字符
			return String.valueOf((char) ascii);
		}

		if (ascii > 96 && ascii < 123) { // 单字符
			return String.valueOf((char) ascii);
		}

		if (ascii < -20319 || ascii > -10247) { // 不知道的字符  -2328鲨
			return null;
		}
	...
	public static void main(String[] args) {
		String str = "阿aA12:吧";
		// 转换成拼音
		System.out.println(PinYin.getFullSpell(str));
		// 中文第一个字全拼,其余去首字母
		System.out.println(PinYin.getFirstSpell(str));
		// ascii 转 字母
		System.out.println(PinYin.getSpellByAscii(65));
		// 字母 转 ascii
		System.out.println(PinYin.getCnAscii('0'));
	}
}
